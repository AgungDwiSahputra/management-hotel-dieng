...
@section('content')
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <!-- Breadcrumb Start -->
        <x-breadcrumb.type-1 :breadcrumbs="[['label' => 'Beranda', 'url' => route('dashboard')], ['label' => 'Admins', 'url' => null]]" />
        <!-- Breadcrumb End -->
        ...
        <div class="space-y-5 sm:space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="border-t border-gray-100 dark:border-gray-800">
                    <!-- ====== Table Six Start -->
                    <x-tables.table-admins 
                        :headers="['ID', 'Nama Admin', 'Email', 'Tanggal Buat', 'Action']"
                        :rows="$admins"
                        :btnAction="[
                            [
                                'label' => 'Detail',
