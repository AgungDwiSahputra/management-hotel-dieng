            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    @if (auth()->check() && auth()->user()->isDeveloper())
                        <li>
                            <a href="profile.html" @click="selected = (selected === 'Booking' ? '':'Booking')"
                                class="menu-item group"
                                :class="(selected === 'Booking') && (page === 'booking') ? 'menu-item-active' :
                                'menu-item-inactive'">
                                <svg :class="(selected === 'Booking') || page === 'booking' ? 'menu-item-icon-active' :
                                    'menu-item-icon-inactive'"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
